...
<!--End NavBar-->
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="profilePictureDiv"><img id="profilePicture" src="http://localhost:3000/uploads/3BD.png"></div>
      </div>

      <div class="col-md-8">
        <div class="row">
          <div class="col-md-12">
            <div id="profileNickName"></div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6"><div id="profileName"></div></div>
          <div class="col-md-6"><div id="profileLastName"></div></div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div id="profileRegDate"></div>
          </div>
        </div>
      </div>
...
<!-- profile picture form -->
  <div class="photoFormulary">
    <form action="functions/modifyProfilePicture.php" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-primary button1" >Modify Profile Picture</button>
